...
namespace CarServiceApp.DataProviders
{
    public class EmployeesProvider : IEmployeesProvider
    {
        ...
        public List<Employee> EmployeeInDepartment(string department)
        {
            var employees = _employeeRepository.GetAll();
                
            return employees.Where(employee => employee.Department.ToUpper() == department.ToUpper()).ToList();          
        }
        ...
        public List<string> GetUniqueDepartment()
        {
            ...
            return departments.Select(employee => employee.Department).Distinct().ToList();
